...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.qy62a.mongodb.net/creativeAgency?retryWrites=true&w=majority`
...
client.connect(err => {
  const Orders = client.db("creativeAgency").collection("bookings");
